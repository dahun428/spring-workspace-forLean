 ...
 * 	@Bean
 * 	- 어노테이션이 부착된 메소드가 반환하는 객체는 컨테이너가 관리한다.
 */
@Configuration
...
public class AppConfig {
	 ...
	 * 태그와 마찬가지로
	 * properties 파일 정보를 읽어서 key/value 값을 가지고 있는 객체를 생성
	 * properties 파일의 위치는 @ProertySource()로 지정한다.
	 */
	@Bean
