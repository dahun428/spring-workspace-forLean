...
//				System.out.println("["+firstSeat+"-"+firstRow+"-"+firstCol+"],["+secondSeat+"-"+secondRow+"-"+secondCol+"]");
...
//				System.out.println("seatGroup : " + seatGroup);
...
//				System.out.println("mate getId : " + mate.getId());
//				System.out.println("seats.get(i) : " + seats.get(i));
				seats.get(i).setMateNo(mate.getId());
				//insertSeat
...
//		System.out.println();
//		System.out.println("------------------------------------------------------------------");
//		System.out.println("performance_main_table Data : " + performance);
//		System.out.println("mate_main table Data : " + mates);
//		System.out.println("hall_seats table Data : " + seats);
//		System.out.println("------------------------------------------------------------------");
//		
	}
}